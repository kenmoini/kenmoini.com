...
So on a traditional Linux system, you would take your Root CA, copy it to a path on the file system, and the run a program which would update the system Root CA Trust Bundle and Java Keystore - along the lines of something like this:
...
- If you want to play with the mounted/system Root CA Bundles inside a container on the cluster, you can use this [pki-toolbox-container](https://github.com/kenmoini/pki-toolbox-container)